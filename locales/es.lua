Locales['es'] = {
  ...
  ['open_cloackroom'] = 'Presiona [E] para abrir su taquilla',
  -- Armory
  ...
  ['helicopter_prompt'] = 'Presiona [E] para acceder a las acciones del helicóptero.',
  ['shop_item'] = '$%s',
  ...
  ['fine'] = 'Multa',
  ['unpaid_bills'] = 'Gestiona las facturas impagas',
  ['license_check'] = 'Gestiona las licencia',
  ['license_revoke'] = 'Revocar licencia',
  ['license_revoked'] = 'Su %s ha sido revocar!',
  ['licence_you_revoked'] = 'Revocaste un %s que pertenecía a %s',
  ['no_players_nearby'] = 'No hay jugadores cerca',
  ['being_searched'] = 'Usted está siendo registrado por la policía',
  -- Vehicle interaction
  ...
  ['you_confiscated'] = 'Confiscaste %sx %s de %s',
  ...
  ['you_confiscated_weapon'] = 'Confiscaste %s de %s con ~o~%s balas',
  ['got_confiscated_weapon'] = 'Tu %s con ~o~%s balas fue confiscado por %s',
  ...
  -- Misc
  ['remove_prop'] = 'Presiona [E] para eliminar el objeto',
  ['map_blip'] = 'Comisaría de policía',
  ['unrestrained_timer'] = 'Sientes que tus esposas pierden agarre lentamente y se desvanecen.',
  -- Notifications
